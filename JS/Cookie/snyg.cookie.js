 ...
 * 苏宁易购 签到 20.5.7
 * 
 * https://github.com/chavyleung/scripts/blob/master/suning/README.md
 * 
 * 
 ...
 * 
 * 【必要】打开APP，系统提示： 获取Cookie: 成功 (登录链接)
【任选】进入主页> 签到有礼，系统提示：获取Cookie: 成功 (每日签到)
【任选】进入主页> 领取红包，系统提示：（获取Cookie: 成功 (每日红包)如果找到领取红包，尝试卸载苏宁重新安装）兼容之前@barrymchen写的snyg.js如果之前有用这个脚本获取过Cookie那不用重新取
【可选】进入主页> 天天低价> 点右上角宝箱，系统提示：获取Cookie: 成功 (天天低价)，获取Cookie: 成功 (查询天天低价)
 */
